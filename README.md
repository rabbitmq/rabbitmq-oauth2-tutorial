...
- [OAuth2 plugin in action](#oauth2-plugin-in-action)
	...
	- [Use Case 6 Use external OAuth server https://auth0.com/](#use-case-6-use-external-oauth-server-httpsauth0com)
	- [Use Case 7 Federation & Shovel](#use-case-5-federation-shovel)
